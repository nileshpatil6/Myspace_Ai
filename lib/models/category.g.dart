...
void _categorySerialize(
  ...
  writer.writeBool(offsets[2], object.isAiGenerated);
...
Category _categoryDeserialize(
  ...
  object.id = id;
  object.isAiGenerated = reader.readBool(offsets[2]);
...
extension CategoryQueryFilter
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> isAiGeneratedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> isUserDefinedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension CategoryQuerySortBy on QueryBuilder<Category, Category, QSortBy> {
  ...
  QueryBuilder<Category, Category, QAfterSortBy> sortByIsAiGenerated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAiGenerated', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByIsAiGeneratedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAiGenerated', Sort.desc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByIsUserDefined() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isUserDefined', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByIsUserDefinedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQuerySortThenBy
  ...
  QueryBuilder<Category, Category, QAfterSortBy> thenByIsAiGenerated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAiGenerated', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByIsAiGeneratedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isAiGenerated', Sort.desc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByIsUserDefined() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isUserDefined', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByIsUserDefinedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isUserDefined', Sort.desc);
    });
  }
...
extension CategoryQueryWhereDistinct
  ...
  QueryBuilder<Category, Category, QDistinct> distinctByIsAiGenerated() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isAiGenerated');
    });
  }

  QueryBuilder<Category, Category, QDistinct> distinctByIsUserDefined() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQueryProperty
  ...
  QueryBuilder<Category, bool, QQueryOperations> isAiGeneratedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isAiGenerated');
    });
  }

  QueryBuilder<Category, bool, QQueryOperations> isUserDefinedProperty() {
    return QueryBuilder.apply(this, (query) {
